...
class LandingPageLocators:
    LOGIN_LINK = (By.XPATH, '//*[@class="AuthButton__SAuthLink-sc-1iwc4q0-0 fqBjCc gtm-auth-header-btn"]')
    LOGIN_WITH_CREDENTIALS_BUTTON = (By.XPATH, '//button[@class="Button__SButton-sc-74bmbt-0 bLqIKi gtm-signup-modal-link"]')
