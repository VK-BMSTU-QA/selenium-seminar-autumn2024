...
class LoginPageLocators(BasePageLocators):
    AUTH_BUTTON = (By.XPATH, "//button[normalize-space()='вход / регистрация']")
    CONTINUE_BUTTON = (By.XPATH, "//button[normalize-space()='Продолжить с помощью почты и пароля']")
    EMAIL_INPUT = (By.ID, "email")
    PASSWORD_INPUT = (By.ID, "password")
    LOGIN_BUTTON = (By.XPATH, "//button[normalize-space()='Войти с паролем']")
...
class MainPageLocators(BasePageLocators):
    ...
    PROFILE_ABOUT_SECTION = (By.XPATH, "//div[contains(@class, 'right-block profile-about')]")
    PROFILE_ABOUT_TEXT = lambda index: (By.XPATH, f".//div[contains(@class, 'profile-about-text')][{index}]")
    TECHNOPARK_MENU_ITEM = (By.XPATH, "//li[contains(@class, 'technopark__menu__item_160')]//a[contains(text(), 'Программа')]")
